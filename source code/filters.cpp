...
void CFilters::filter_init_2xsai(Uint32 BitFormat)
{
    if(BitFormat == 565)
    {
...
void CFilters::filter_super2xsai(Uint8 *srcPtr, Uint32 srcPitch,
...
void CFilters::filter_supereagle(Uint8 *srcPtr, Uint32 srcPitch, /* Uint8 *deltaPtr,  */
...
void CFilters::filter_2xsai (Uint8 *srcPtr, Uint32 srcPitch,
                             Uint8 *dstPtr, Uint32 dstPitch, int width, int height)
{
    Uint8  *dP;
    Uint16 *bP;
...
void CFilters::filter_advmame2x(Uint8 *srcPtr, Uint32 srcPitch,
                                Uint8 *dstPtr, Uint32 dstPitch,
                                int width, int height)
{
...
void CFilters::filter_tv2x(Uint8 *srcPtr, Uint32 srcPitch,
                           Uint8 *dstPtr, Uint32 dstPitch,
                           int width, int height)
{
...
void CFilters::filter_normal2x(Uint8 *srcPtr, Uint32 srcPitch,
                               Uint8 *dstPtr, Uint32 dstPitch,
                               int width, int height)
{
    unsigned int nextlineSrc = srcPitch / sizeof(Uint16);
...
void CFilters::filter_dotmatrix(Uint8 *srcPtr, Uint32 srcPitch,
                                Uint8 *dstPtr, Uint32 dstPitch,
                                int width, int height)
{
    unsigned int nextlineSrc = srcPitch / sizeof(Uint16);
...
void CFilters::filter_bilinear(Uint8 *srcPtr, Uint32 srcPitch,
                               Uint8 *dstPtr, Uint32 dstPitch,
                               int width, int height)
{
    unsigned int nextlineSrc = srcPitch / sizeof(Uint16);
...
void CFilters::filter_bicubic(Uint8 *srcPtr, Uint32 srcPitch,
                              Uint8 *dstPtr, Uint32 dstPitch,
                              int width, int height)
{
    unsigned int nextlineSrc = srcPitch / sizeof(Uint16);
